...
% Dyadic orthogonal discrete wavelet transform decomposition - The signal length must be power of 2.
%
...
p=maxlevel(x);
if (p==0),
    disp('Error: The signal length should be a power of 2. The transform cannot be calculated');
    c=[];
    l=[];
    return
else
